...
public class ProjetoFuncionario implements Serializable {
	...
	@javax.validation.constraints.NotNull(message="O Funcionario deve ser informado")
	@ManyToOne
	@JoinColumn(name="FUNCIONARIO", referencedColumnName="ID", nullable=false)
	
	private Funcionario funcionario;
	@javax.validation.constraints.NotNull(message="O Projeto deve ser informado")
	@ManyToOne
